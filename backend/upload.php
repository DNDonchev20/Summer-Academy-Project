...
$thumbnail = basename( $_FILES["fileToUpload"]["name"]);

$query="INSERT INTO courses (
    category_id, title, description, user_id, keywords, thumbnail
) VALUES (:category_id, :title, :description, :user_id, :keywords, :thumbnail)";
$params = [
